        ...
        <div class="container mt-3">
            <div class="row">
                ...
                <div class="col-lg-9">
                     ...
                     <div class="row">
                        <?php $ambil = $koneksi->query("SELECT * FROM produk_sewa LEFT JOIN user ON produk_sewa.id_user=user.id_user");?>
                        ...
                        <div class="col-lg-3 col-xs-12 col-sm-6 mb-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="sewa.php?id=<?=$perproduk['id_produksewa']?>"><button class="btn btn-primary">Sewa</button></a>
